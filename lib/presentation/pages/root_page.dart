  ...
  Widget build(BuildContext context) {
    return Consumer<AppSettingsState>(
      builder: (context, appSettings, _) {
        final AppThemes appThemes = AppThemes(appSettings.appThemeColor, appSettings.getAppLocaleIndex == 4 ? AppStringConstraints.fontSix : AppStringConstraints.fontOne);
        return MaterialApp(
